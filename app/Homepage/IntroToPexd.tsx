    ...
    <div>
        ...
        <div className='w-full mt-20 mb-30'>
            ...
            <div className='flex max-sm:flex-col w-full px-35 max-sm:px-2 gap-7 mt-20 max-sm:mt-10 max-2md:px-15 max-2md:gap-3 max-md:px-5 max-md:gap-2'>
                ...
                <h1 className='text-[#001a47d3] text-[22px] font-semibold max-sm:text-[20px]'>Design Without Limits</h1>
                ...
                <h1 className='text-white text-[22px]'>Expert Guidance at Every Step</h1>
                ...
                <h1 className='text-white text-[22px]'>100% Reliable, Professional Results</h1>
