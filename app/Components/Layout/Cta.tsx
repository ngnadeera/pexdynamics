...
const Cta = () => {
  return (
    <div className='my-10 px-20  z-20 max-2md:px-10 max-sm:px-2'>
        ...
        style={{ backgroundImage: "url(assets/Homepage/Cta/cta-bg.jpg)" }}
        
        className='relative w-full z-10 py-20  bg-cover bg-center  flex flex-col justify-center items-center rounded-[35px]'>
